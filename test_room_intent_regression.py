...
sys.path.insert(0, "/home/claude/repo4")

REPO = Path("/home/claude/repo4")
...
check(
    "D: the exact reported query returns a room-availability "
    "response (a truthful 'cannot be determined' message here, "
    "since this real uploaded dataset has no room-free data - "
    "which is the explicitly correct behavior per the spec)",
